    ...
    <div className="min-h-screen flex items-center justify-center bg-vanilla/30">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="font-playfair text-3xl font-bold text-chocolate mb-2">Create Account</h1>
          <p className="text-chocolate/60">Join Happy Truffles Cafe</p>
        </div>
        ...
        <p className="text-center text-chocolate/60 text-sm mt-6">
          ...
          <Link href="/login" className="text-truffle hover:underline font-medium">
            Sign In
          </Link>
        </p>
      </motion.div>
