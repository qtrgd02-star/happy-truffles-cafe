          ...
          {loading ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="rounded-lg p-4 border border-chocolate/10 bg-vanilla/10">
                  <div className="h-4 bg-vanilla/30 rounded animate-pulse w-3/4 mb-2" />
                  <div className="h-3 bg-vanilla/20 rounded animate-pulse w-1/2 mb-4" />
                  <div className="flex items-center justify-between">
                    <div className="h-8 bg-vanilla/30 rounded animate-pulse w-24" />
                    <div className="h-3 bg-vanilla/20 rounded animate-pulse w-16" />
                  </div>
                </div>
              ))}
            </div>
